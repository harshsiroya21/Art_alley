...
<%
    ...
    if (user == null || !"SELLER".equals(user.getRole()) || product == null || product.getSellerId() != user.getId()) {
    ...
    <div class="container">
        <div class="form-container">
            ...
            <form action="product" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                ...
                <input type="hidden" name="currentImageUrl" value="<%= product.getImageUrl() != null ? product.getImageUrl() : "" %>">
