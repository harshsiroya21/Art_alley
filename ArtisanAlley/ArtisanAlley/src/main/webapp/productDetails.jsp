...
<head>
    ...
    <style>
        ...
        .btn { background-color: #A0522D; color: white; padding: 12px 24px; text-decoration: none; border-radius: 4px; display: inline-block; border: 1px solid #ccc; width: 180px; height: 40px; text-align: center; box-sizing: border-box; white-space: nowrap; font-family: 'Poppins', sans-serif; }
        .button-container { display: flex; gap: 1rem; align-items: center; }
...
<body>
    <div class="header">
        <% if (user != null) { %>
            <a href="<%= "CUSTOMER".equals(user.getRole()) ? "customerDashboard" : "SELLER".equals(user.getRole()) ? "sellerDashboard" : "adminDashboard" %>" style="color: white; text-decoration: none;"><img src="logo.png" alt="Artisan Alley Logo" style="height: 40px; vertical-align: middle;"> <span>Artisan Alley</span></a>
        <% } else { %>
            <a href="index.jsp" style="color: white; text-decoration: none;"><img src="logo.png" alt="Artisan Alley Logo" style="height: 40px; vertical-align: middle;"> <span>Artisan Alley</span></a>
        <% } %>
        <% if (user != null) { %>
